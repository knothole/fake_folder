========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : Fox
========================================================================


AppWizard が生成した Fox には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには Fox を構成している各ファイルの概要説明が含まれています。
...
Fox.h
    ...
    みます） をインクルードし、また CFoxApp アプリケーションクラスを宣
    言します。

Fox.cpp
    このファイルは CFoxApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\Fox.ico
    ...
    ルです。このアイコンはリソース ファイル Fox.rc によってインクルード
    されます。
...
FoxDlg.h, FoxDlg.cpp - ダイアログ
    これらのファイルは CFoxDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な Fox.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) Fox.pch 
